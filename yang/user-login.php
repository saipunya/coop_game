...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    label { display: block; margin: 15px 0 7px; font-weight: 900; font-size: 14px; }
    input {
      width: 100%;
      height: 48px;
      padding: 0 13px;
    ...
    input:focus { outline: 3px solid rgba(29, 122, 84, 0.16); border-color: var(--green); background: #fff; }
    .alert {
      padding: 12px 13px;
      border-radius: 7px;
